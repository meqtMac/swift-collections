...
/// high-level set operations such as ``union(_:)-57kn6``,
/// ``intersection(_:)-2u1y6`` or ``isSubset(of:)-416mb``.
///
...
///
/// On the other hand, predicates such as ``isSubset(of:)-3z8rs`` tend to ignore
/// element ordering:
///
...
/// - ``remove(at:)``
/// - ``removeSubrange(_:)-i7fc``, ``removeSubrange(_:)--6hqfe`
