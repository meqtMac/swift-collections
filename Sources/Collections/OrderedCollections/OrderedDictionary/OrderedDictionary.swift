...
/// (``init(uniqueKeysWithValues:)-8rhao``, ``init(_:uniquingKeysWith:)-6xgvr``,
/// ``init(grouping:by:)-7pkuu``), methods for merging one dictionary with
/// another (``merge(_:uniquingKeysWith:)-9wbar``,
/// ``merging(_:uniquingKeysWith:)-7o10p``), filtering dictionary entries
...
/// - ``remove(at:)``
/// - ``removeSubrange(_:)-4ddhn``, ``removeSubrange(_:)-4ddhn``
